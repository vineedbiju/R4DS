...
table1 %>% group_by(year) %>% summarise(total_cases = sum(cases), total_population = sum(population),
...
table5 <- table3 %>% separate(year, into = c("millenium","century", "year"), sep = c(1,2))
...
```{r}
unite(table5, year, "millenium", century, year)
#for no arguments between joined variables :-
unite(table5, year,"millenium", century, year, sep = "")
