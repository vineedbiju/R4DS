---
title: "Tibbles with tibble, Part 1"
...
as_tibble(iris) #coercing a dataframe as a tibble
tibble(
  a = 1:5,
  b =2+a,
...
#Tibbles print only the first 10 ns and Width that can be observed in the console

nycflights13::flights
nycflights13::flights %>% print(
  n = 15, width = Inf
) #here the output in the console will be what's required
